...
Rectangle {
    ...
    Flickable {
        ...
        TextArea {
            ...
            <p>Oh, and I also included a new System Config Tool, that will start once OS is installed, which you can use to Set up Snapper, Grub-BTRFS as well as do some system maintenance. Once you remove from Autostart you will still be able to access via alias mentioned in the app itself .</p>
